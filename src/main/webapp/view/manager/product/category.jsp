...
<head>
    ...
    <link rel="stylesheet" href="${APP_PATH}/font_928736_0brlg16h0tvm/iconfont.css">
    <style>
        .tree li {
...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="#">TFG - 商品分类</a></div>
        </div>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="glyphicon glyphicon-th"></i> 许可数</h3>
                </div>
...
<script type="text/javascript">
    ...
    function loadData() {
        $.ajax({
            url:"${APP_PATH}/category/loadData.do",
            type:"post",
